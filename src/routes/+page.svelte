<div class="relative isolate overflow-hidden bg-zinc-900 w-dvw h-dvh">
  ...
  <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
    <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
      ...
      <p class="mt-6 text-lg leading-8 text-gray-300">I'm a <span class="italic">Technical lead developer</span> currently working at <a href="https://weinvest.be">We Invest Real Estate</a>.</p>
